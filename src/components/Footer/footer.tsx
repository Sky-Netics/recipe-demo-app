    ...
    return (
        <div className="w-full  h-[800px]">
            ...
            <div className="flex flex-col items-center mx-auto bg-carrot py-[55px] text-white w-[75%] rounded-md transform translate-y-[80px] relative z-10">
                ...
                <h1 className="mb-16">Subscribe To Our NewsLetter</h1>
                <p className="text-[14px]">And never miss latest Updates!</p>

                <div className="flex justify-center mt-5 w-8/12 bg-blue-400">
            ...
            <div className="bg-[#FFEA74] pt-[250px] pb-[10px] flex">

                <div className="w-4/12 flex flex-col items-center border-r">
                    <h2 className="text-[26px] mb-5">Contacts Us</h2>

                    <p className="text-[16px]">9 W 53rd st, New York, NY 10019, USA</p>
                ...
                <div className="w-4/12 flex flex-col items-center">
                    ...
                    <p className="text-[16px] py-[50px]">* a unique recipe sharing and discovery platform*</p>
                </div>

                <div className="w-4/12 flex flex-col pl-[180px] ">
            ...
            <div className="text-center bg-[#FFEA74] pb-[120px]">
