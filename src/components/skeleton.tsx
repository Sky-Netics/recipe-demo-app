    ...
    const renderByCount = () =>{
        ...
        for (let i = 0 ; i<count ; i++){
            ...
            <div className="shadow-2xl rounded p-4">
                <div><div className="skeleton skeleton-w-full skeleton-h-full"></div></div>
                <div>
                    <p className="my-5 skeleton skeleton-w-20 skeleton-h-20"></p>
                    <div className="flex justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="skeleton skeleton-w-10 skeleton-h-15"></p>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="flex justify-between items-center my-5">
                        <div>
                            <div className="skeleton skeleton-w-15 skeleton-h-25"></div>
                        </div>
                        <div className="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
