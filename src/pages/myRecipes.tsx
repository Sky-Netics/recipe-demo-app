            ...
            <div className="xl:ml-60">
                <div className="p-8">
                    <div className="flex justify-end">
                        <Link to={'/dashboard/my-recipes/create?my-recipes'} className="bg-carrot text-white py-2 px-4 rounded-2xl flex items-center gap-1">
                                ...
                                return (
                                    <div className="shadow-2xl rounded p-4" key={i}>
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <div className="flex items-center cursor-pointer gap-3 rounded-md bg-pureRed px-2 py-1">
